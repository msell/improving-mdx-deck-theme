...
### In this next [example](https://codesandbox.io/s/z6pommq8km), let’s look at how you can focus an input control upon first render, using useEffect combined with the useRef hook.
